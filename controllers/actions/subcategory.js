...
const getAllSubCategories = async(req, res) => {
    ...
    try{
        ...
        const mQuery = 'SELECT * FROM sub_categories';
...
const getSubCategory = async(req, res) => {
    ...
    try{
        ...
        const mQuery = 'SELECT * FROM sub_categories WHERE id = ?';
...
const addSubCategory = async (req, res) => {
    ...
    try{
        ...
        const mQuerySelect = 'SELECT * FROM sub_categories WHERE name = ?';
        ...
        mysqlConnection.query(mQuerySelect,[bodyData.name], (error, rows, fields) => {
            ...
            if (!error){
                ...
                if(!rows[0]){
                    ...
                    const mQuery = 'INSERT INTO sub_categories SET?';
...
const updateSubCategory = async (req, res) => {
    ...
    try{
        ...
        const mQuery = 'UPDATE sub_categories SET? WHERE id =?';
...
const deleteSubCategory = async (req, res) => {
    ...
    try{
        ...
        const mQuery = 'DELETE FROM sub_categories WHERE id = ?';
        mysqlConnection.query(mQuery, [uID], (error, rows, fields) => {
